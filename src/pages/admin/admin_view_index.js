                      ...
                      <span class="nav-link-title" >
                        <button class="btn" onClick={() => { setPage("CONFIG") }} style={{borderWidth : 0, backgroundColor : '#02395E'}}>
                          ...
                          <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" color='white'
                            width="100" height="10" viewBox="0 0 24 24" stroke-width="10" stroke="currentColor" 
                            fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <rect x="3" y="4" width="18" height="12" rx="1" /><line x1="7" y1="20" x2="17" y2="20" /><line x1="9" y1="16" x2="9" y2="20" />
                    ...
                    <a class="nav-link">
                      <span class="nav-link-title">
                        <button class="btn" onClick={() => { setPage("RESUMEN") }} style={{borderWidth : 0, backgroundColor : '#02395E'}}>
                          ...
                          <h4 style={{color : 'white'}}>FACTURAS ACTIVAS</h4>
                          </button>
                      </span>
                    </a>
                  </li>
